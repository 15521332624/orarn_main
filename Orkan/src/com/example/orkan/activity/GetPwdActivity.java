...
public class GetPwdActivity extends BaseActivity{
    ...
    private void init(){
    	...
    	title_tx.setText(R.string.get_pwd);
    ...
    private void getCheckNum(){
    	...
    	beginAll();
    	 FinalHttp fh = new FinalHttp();
 		 fh.get(Util.URL+"Login/getPassword/sendCode/" + accountEdit.getText().toString().trim(), new AjaxCallBack<String>() {
 			@Override
    ...
    private void reg(){
    	...
    	beginAll();
         ...
         params.put("captcha", checknumEdit.getText().toString().trim());
 		 ...
 		 fh.post(Util.URL+"Login/getPassword", params, new AjaxCallBack<String>() {
 			@Override
 			public void onSuccess(String t){
 				super.onSuccess(t);
 				try {
    ...
    class TimeCount extends CountDownTimer {
	    ...
	    public void onFinish() {//计时完毕时触发
	    	...
	    	checknumButton.setTextColor(GetPwdActivity.this.getResources().getColor(R.color.theme_color));
	    }
	    @Override
	    public void onTick(long millisUntilFinished){//计时过程显示
	    	checknumButton.setClickable(false);
	    	checknumButton.setTextColor(GetPwdActivity.this.getResources().getColor(R.color.lb_tx));
