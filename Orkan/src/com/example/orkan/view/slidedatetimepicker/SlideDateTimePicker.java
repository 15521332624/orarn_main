...
public class SlideDateTimePicker
{
    ...
    private int mPickerMode = SlideDateTimeDialogFragment.DATE_AND_TIME_MODE;
    ...
    public void setPickerMode(int mode){
    	switch(mode){
    		case SlideDateTimeDialogFragment.DATE_AND_TIME_MODE:
    			mPickerMode = SlideDateTimeDialogFragment.DATE_AND_TIME_MODE;
    			break;
    		case SlideDateTimeDialogFragment.DATE_MODE:
    			mPickerMode = SlideDateTimeDialogFragment.DATE_MODE;
    			break;
    		case SlideDateTimeDialogFragment.TIME_MODE:
    			mPickerMode = SlideDateTimeDialogFragment.TIME_MODE;
    			break;
    		default:
                break;
    	}
    ...
    public static class Builder
    {
        ...
        public Builder setPickerMode(int pickerMode)
        {
        ...
        public SlideDateTimePicker build()
        {
            ...
            picker.setPickerMode(mPickerMode);
            return picker;
        }
    }
}
