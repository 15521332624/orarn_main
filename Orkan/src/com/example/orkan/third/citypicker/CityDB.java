...
public class CityDB implements Parcelable {
	...
	public CityDB(String name, String postID, long refreshTime, int isLocation, long pubTime, String weatherInfoStr) {
		super();
		this.name = name;
		this.postID = postID;
	...
	public CityDB(String name, String postID) {
		super();
		this.name = name;
		this.postID = postID;
	}

	public CityDB(String province, String city, String name, String pinyin,
	...
	public boolean equals(Object o) {
		...
		if (o == this)
			return true;
		if (o instanceof CityDB) {
			CityDB item = (CityDB) o;
	...
	public static final Parcelable.Creator<CityDB> CREATOR = new Creator<CityDB>() {

		@Override
		public CityDB createFromParcel(Parcel source) {
